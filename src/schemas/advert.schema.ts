...
import {commentSchema, commentSchemaResponse} from '../schemas/comment.schema';
...
export const advertSchemaRequest = advertSchema.omit({ id: true, user: true, images: true, comments:true})
...
export const advertSchemaResponse = advertSchema.partial({ images: true,comments:true})
